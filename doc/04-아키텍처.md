...
| :--- | :--- | :--- | :--- |
| **타깃 모바일 기기** | Android 8.0 (Oreo)+ / iOS 14.0+ | Android 14+ / iOS 17+ | 스마트폰, 태블릿, iPad 지원 |
| **프로세서 (AP/CPU)** | ARM64 옥타코어 / Apple A12 Bionic 이상 | Snapdragon 8 Gen 2/3 / Apple A16/A17 Pro, M-Series | In-Memory 디플레이트 및 120Hz 렌더링 |
| **메모리 (RAM)** | 3GB RAM 이상 | 8GB RAM 이상 | 대용량 10GB 아카이브 처리 시에도 150MB 내외 유지 |
