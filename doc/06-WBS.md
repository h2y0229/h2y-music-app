# 06. WBS 및 가용 공수 분석 (Capacity Analysis)

> **일정 및 공수 분석서**: 전체 개발 일정을 Mermaid Gantt 차트로 시각화하고, 총 가용 공수, 투입 공수, 버퍼 및 1인+AI 페어 프로그래밍 생산성 갭 비교를 분석합니다.
...
## 3. 공정별 공수 집계 및 비율 요약 (FORM-06-02)

| 공정 구분 | Task 수 | 공수 (M/D) | 비율 (%) | 세부 내용 및 공정 구성 |
| :---: | :---: | :---: | :---: | :--- |
| **분석 (A)** | 1 | 1.0 M/D | 5.6% | 아카이브 바이너리 구조 및 VFS 인덱싱 기술 영향분석 |
| **설계 (D)** | 2 | 1.5 M/D | 8.3% | Web Worker 스트리밍 아키텍처 및 Glassmorphism UI 시스템 설계 |
| **개발 (C)** | 13 | 11.5 M/D | 63.9% | 아카이브 VFS, 오디오 파이프라인, 태그 파서, 스토리지, UI 구현 |
| **테스트 (T)** | 3 | 3.0 M/D | 16.7% | TTFP 저지연 검증, 10GB 아카이브 메모리 프로파일링, E2E 통합 테스트 |
| **배포 (D)** | 1 | 1.0 M/D | 5.6% | 프로덕션 최적화 빌드 번들링 및 크로스 플랫폼 패키징 배포 |
| **합계** | **20** | **18.0 M/D** | **100.0%** | **전체 4개 Sprint 통합 개발 공정** |

---

## 4. 공정별 공수 누적 집계 표 (FORM-06-03)

| 대분류 (제품군) | 영향분석 (A) | 아키텍처 설계 (D) | 코딩 및 개발 (C) | 테스트 및 이관 (T/D) | 합계 (M/D) |
| :---: | :---: | :---: | :---: | :---: | :---: |
| `MUSIC` (음악 앱 코어) | 1.0 M/D | 1.5 M/D | 11.5 M/D | 4.0 M/D | **18.0 M/D** |

---

## 5. 주요 마일스톤 (FORM-06-04)
...
## 6. 총 가용 공수 vs 투입 공수 요약 분석 (FORM-06-05)
...
## 7. Sprint별 가용 공수 vs 투입 공수 및 버퍼 비교 (FORM-06-06)
...
## 8. 예상 공수(순수 인간 vs 1인+AI) 비교 분석표 (FORM-06-08)
