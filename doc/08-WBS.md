...
## 3. 공정별 공수 집계 및 비율 요약 (FORM-08-02)
...
## 6. 총 가용 공수 vs 투입 공수 요약 분석 (FORM-08-05)
...
## 7. Sprint별 가용 공수 vs 투입 공수 및 버퍼 비교 (FORM-08-06)
...
## 8. 예상 공수(순수 인간 vs 1인+AI) 비교 분석표 (FORM-08-08)
...
| **아카이브 및 오디오 코어 개발** | 11.0 M/D | 4.5 M/D | -6.5 M/D | 4.5 M/D | **59.1% 절감** | Isolate/바인딩 스캐폴딩 및 오디오 노드 체인 AI 페어 코딩 가속 |
| **메타데이터 파서 & 스토리지** | 9.5 M/D | 4.5 M/D | -5.0 M/D | 4.5 M/D | **52.6% 절감** | ID3/LRC 파서 정규식 및 로컬 스토리지 보일러플레이트 자동 생성 |
| **EQ, UI 및 최적화/배포** | 14.0 M/D | 6.5 M/D | -7.5 M/D | 6.5 M/D | **53.6% 절감** | Flutter 반응형 UI 디자인 시스템 및 5대 OS 빌드 스크립트 AI 자동 생성 |
...
| `v2.2` | 2026-09-05 | 산출물 표준 v2.2 개편: 08-WBS(FORM-08-*) 번호 재배치 및 가용 공수/마일스톤 동기화 | 풀스택 개발팀 |
